...
export async function fetchSummary(
  query?: Partial<Pick<ReceiptQuery, "q" | "from" | "to" | "category" | "unassigned" | "source">>,
 ...
 * Dienst: nur wenn sich ein Fachwert tatsaechlich aendert. Liegt der Beleg in
 * einer eingereichten Abrechnung, lehnt der Dienst mit code "locked" ab.
 */
