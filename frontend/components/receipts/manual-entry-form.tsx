...
export function ManualEntryForm({
  ...
  today: string;
  /** Offene Abrechnungsentwuerfe, in die die Ausgabe gleich gelegt werden kann. */
      ...
      <div className="grid grid-cols-2 gap-[18px]">
        ...
        <div className="col-span-2">
          <Field
            ...
            hint={drafts.length > 0 ? "Assign right away" : "No draft settlement yet"}
          >
            <select
              name="settlementId"
              defaultValue={initial("settlementId")}
              className={SELECT_CLASS}
              style={CHEVRON}
            >
